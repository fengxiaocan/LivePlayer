...
public class SystemBarTintManager {
    ...
    static {
        try {
            ...
            boolean sIsMiuiV6 = "V6".equals((String) getStringMethod.invoke(sysClass, "ro.miui.ui.version.name"));
            boolean sIsMiuiV7 = "V7".equals((String) getStringMethod.invoke(sysClass, "ro.miui.ui.version.name"));
            boolean sIsMiuiV8 = "V8".equals((String) getStringMethod.invoke(sysClass, "ro.miui.ui.version.name"));
            sIsMiui = sIsMiuiV6|sIsMiuiV7|sIsMiuiV8;
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void setStatusBarTintResource(int res) {
        if (mStatusBarAvailable) {
           //mStatusBarTintView.setBackgroundResource(R.color.transparent);
