...
public final class SpannableStringUtils {
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new CustomImageSpan(Utils.getContext(),bitmap,align),
                                     start,
                                     end,
                                     flag);
                    bitmap = null;
                    ...
                    mBuilder.setSpan(
                            new CustomImageSpan(Utils.getContext(),uri,align),
                            start,
                            end,
                            flag
                    );
                    ...
                    mBuilder.setSpan(
                            new CustomImageSpan(Utils.getContext(),resourceId,align),
                            start,
                            end,
                            flag
                    );
    ...
    static abstract class CustomDynamicDrawableSpan extends ReplacementSpan {
        ...
        )
        {
            ...
            final int fontHeight = (int)(paint.getFontMetrics().descent -
